...
class MainActivity : AppCompatActivity() {
    // Made internal for testing accessibility
    internal lateinit var btnScanNetworks: MaterialButton
    internal lateinit var rvWifiNetworks: RecyclerView
    internal lateinit var tvNoNetworks: TextView
    ...
    internal fun updateNetworksList() {
